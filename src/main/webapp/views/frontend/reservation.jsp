...
<%
    List<Hotel> hotelList = (List<Hotel>)request.getAttribute("model");
%>
   ...
   <div class="col-xs-9">
     <form class="form-horizontal" name="res" >
       <div class="form-group">
         <label class="control-label col-sm-2" for="aps">Hotel:</label>
         <div class="col-sm-10">
           <select class="form-control" id="aps" name="apartment">
             <option selected value="1">none</option>
               ...
               %>
             <option value="<%=i+2%>"><%=hotel.getAddress()%></option>
               <%}%>
           </select>
           </div>
       </div>
